...
@include('admin.ip_setting.create_modal')
@include('admin.ip_setting.edit_modal')
@include('admin.ip_setting.confirm_modal')
@include('admin.ip_setting.bulk_delete_confirm')

{{-- @include('admin.performance.goal-type.delete-confirm-modal') --}}
{{-- @include('admin.performance.goal-type.delete-checkbox-confirm-modal')  --}}
