...
@include('admin.performance.indicator.create-modal')
@include('admin.performance.indicator.edit-modal')
@include('admin.performance.indicator.delete-modal')
@include('admin.performance.indicator.delete-checkbox-confirm-modal')
