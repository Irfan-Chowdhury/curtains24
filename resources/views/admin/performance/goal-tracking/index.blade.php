...
@include('admin.performance.goal-tracking.create-modal')
@include('admin.performance.goal-tracking.edit-modal')
@include('admin.performance.goal-tracking.delete-modal')
@include('admin.performance.goal-tracking.delete-checkbox-confirm-modal')
