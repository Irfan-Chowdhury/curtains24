...
@include('admin.version-elevate::includes.session_message')
    ...
    <div class="row">
        ...
        <div class="col-8">
            <div class="tab-content" id="nav-tabContent">
                ...
                <!--General Setting-->
                @include('admin.version-elevate::developer_section.general')

                <!-- Version Upgrade Setting -->
                @include('admin.version-elevate::developer_section.version_upgrade_setting')
            </div>
        </div>
    </div>
</div>
