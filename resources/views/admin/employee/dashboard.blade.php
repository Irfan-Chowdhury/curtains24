            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        @include('admin.employee.profile_picture.index')
                        ...
                        <div class="tab-pane fade" id="Set_salary" role="tabpanel" aria-labelledby="set_salary-tab">
                            ...
                            {{__('Salary Info')}}
                            <hr>
                        @include('admin.employee.salary.index')
                        ...
                        <div class="tab-pane fade" id="Leave" role="tabpanel" aria-labelledby="leave-tab">
                            ...
                            {{__('Leave Info')}}
                            <hr>
                        @include('admin.employee.leave.index')
                        ...
                        <div class="tab-pane fade" id="Employee_Core_hr" role="tabpanel"
                            ...
                            {{__('Core HR')}}
                            <hr>
                        @include('admin.employee.core_hr.award.index')
                        ...
                        <div class="tab-pane fade" id="Employee_project_task" role="tabpanel"
                            ...
                            <hr>
                        @include('admin.employee.project_task.index')
                        ...
                        <div class="tab-pane fade" id="Employee_Payslip" role="tabpanel"
                            ...
                            {{trans('file.Payslip')}}
                            <hr>
                            @include('admin.employee.payslip.index')
                            <!--Contents for Contact ends here-->
                        </div>
                        ...
                        <div class="tab-pane fade" id="remainingLeaveType" role="tabpanel"
                            ...
                            <hr>
                            @include('admin.employee.remaining_leave.index')
                        </div>
...
<script type="text/javascript">
    ...
    $('[data-table="immigration"]').one('click', function (e) {
            @include('admin.employee.immigration.index_js')

    });

    $('[data-table="emergency"]').one('click', function (e) {
        @include('admin.employee.emergency_contacts.index_js')
    });

    $('[data-table="document"]').one('click', function (e) {
            @include('admin.employee.documents.index_js')
    });

    $('[data-table="qualification"]').one('click', function (e) {
        @include('admin.employee.qualifications.index_js')
    });

    $('[data-table="work_experience"]').one('click', function (e) {
        @include('admin.employee.work_experience.index_js')
    });

    $('[data-table="bank_account"]').one('click', function (e) {
        @include('admin.employee.bank_account.index_js')
    });

    $('#profile-tab').one('click', function (e) {
        @include('admin.employee.profile_picture.index_js')
    });

    $('#set_salary-tab').one('click', function (e) {
       @include('admin.employee.salary.basic.index_js') //employee.salary.index_js.blade.php - both are same
    });

    $('#salary_allowance-tab').one('click', function (e) {
        @include('admin.employee.salary.allowance.index_js')
    });

    $('#salary_commission-tab').one('click', function (e) {
        @include('admin.employee.salary.commission.index_js')
    });

    $('#salary_loan-tab').one('click', function (e) {
        @include('admin.employee.salary.loan.index_js')
    });

    $('#salary_deduction-tab').one('click', function (e) {
        @include('admin.employee.salary.deduction.index_js')
    });

   $('#other_payment-tab').one('click', function (e) {
        @include('admin.employee.salary.other_payment.index_js')
    });

    $('#salary_overtime-tab').one('click', function (e) {
        @include('admin.employee.salary.overtime.index_js')
    });

    $('#salary_pension-tab').one('click', function (e) {
        @include('admin.employee.salary.pension_amount_js')
    });


    $('#leave-tab').one('click', function (e) {
        @include('admin.employee.leave.index_js')
    });


    $('#remainingLeaveType-tab').one('click', function (e) {
        @include('admin.employee.remaining_leave.index_js')
    });



    $('#employee_core_hr-tab').one('click', function (e) {
        @include('admin.employee.core_hr.award.index_js')
    });

    $('#employee_travel-tab').one('click', function (e) {
        @include('admin.employee.core_hr.travel.index_js')
    });

    $('#employee_training-tab').one('click', function (e) {
        @include('admin.employee.core_hr.training.index_js')
    });

    $('#employee_ticket-tab').one('click', function (e) {
        @include('admin.employee.core_hr.ticket.index_js')
    });


    $('#employee_transfer-tab').one('click', function (e) {
        @include('admin.employee.core_hr.transfer.index_js')
    });


    $('#employee_promotion-tab').one('click', function (e) {
        @include('admin.employee.core_hr.promotion.index_js')
    });

    $('#employee_complaint-tab').one('click', function (e) {
        @include('admin.employee.core_hr.complaint.index_js')
    });


    $('#employee_warning-tab').one('click', function (e) {
        @include('admin.employee.core_hr.warning.index_js')
    });

    $('#employee_project_task-tab').one('click', function (e) {
        @include('admin.employee.project_task.project.index_js')

    });

    $('#employee_task-tab').one('click', function (e) {
        @include('admin.employee.project_task.task.index_js')
    });

    $('#employee_payslip-tab').one('click', function (e) {
        @include('admin.employee.payslip.index_js')
    });
