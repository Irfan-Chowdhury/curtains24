...
@include('admin.calendarable.holiday')
@include('admin.calendarable.leave')
@include('admin.calendarable.travel')
@include('admin.calendarable.training')
@include('admin.calendarable.project')
@include('admin.calendarable.task')
@include('admin.calendarable.event')
@include('admin.calendarable.meeting')
