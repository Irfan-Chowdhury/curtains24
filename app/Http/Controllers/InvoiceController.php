...
class InvoiceController extends Controller {
	...
	public function index()
	{
		...
		if ($logged_user->can('view-invoice'))
		{
			...
			return view('admin.projects.invoices.index');
		}
	...
	public function create()
	{
		...
		return view('admin.projects.invoices.create', compact('projects', 'tax_types', 'invoice_number'));
	}
	...
	public function show(Invoice $invoice)
	{
		...
		if (auth()->user()->can('view-invoice')||$invoice->client_id == auth()->user()->id)
		{
			...
			if (auth()->user()->role_users_id == 3){
				return view('admin.client.invoice_show', compact('invoice', 'invoice_items', 'project', 'company', 'client','location'));
			}

			return view('admin.projects.invoices.show', compact('invoice', 'invoice_items', 'project', 'company', 'client','location'));
		}
		return abort('403', __('You are not authorized'));
	}
	...
	public function edit(Invoice $invoice)
	{
		if (auth()->user()->can('edit-invoice')) {
			...
			return view('admin.projects.invoices.edit', compact('invoice', 'invoice_items', 'tax_types', 'projects'));
		}
		return abort('403', __('You are not authorized'));
	}
