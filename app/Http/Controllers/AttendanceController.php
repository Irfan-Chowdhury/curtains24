...
class AttendanceController extends Controller {
	...
	public function index(Request $request)
	{
		...
		// {
			...
			return view('admin.timesheet.attendance.attendance');
		// }
    ...
    //     return view('admin.timesheet.dateWiseAttendance.index', compact('companies'));
	// }
	...
	public function monthlyAttendance(Request $request)
	{
		...
		// {
			...
			return view('admin.timesheet.monthlyAttendance.index', compact('companies'));
		// }
		// return response()->json(['success' => __('You are not authorized')]);
	}
	...
	public function updateAttendance(Request $request)
	{
		...
		if ($logged_user->can('edit-attendance'))
		{
			...
			return view('admin.timesheet.updateAttendance.index', compact('companies'));
		}
		return response()->json(['success' => __('You are not authorized')]);
	}
	...
	public function import()
	{
		...
		if ($logged_user->can('delete-attendance'))
		{
			return view('admin.timesheet.attendance.import');
		}
