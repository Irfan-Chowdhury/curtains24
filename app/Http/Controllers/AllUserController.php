...
class AllUserController extends Controller {
    ...
    public function index()
    {
        ...
        $users = User::with('RoleUser')->orderBy('is_active','desc')->get();
        	...
        	if ($logged_user->can('view-user')){
                ...
                return view('admin.all_user.index');
            }
	...
	// 		return view('admin.all_user.add_user_form', $data);
	// 	}
	...
	public function login_info()
	{
		...
		if ($logged_user->can('last-login-user'))
		{
			...
			return view('admin.all_user.login_info', ['login_info' => $login_info]);
		}
	...
	public function user_roles()
	{
		...
		if ($logged_user->can('role-access-user'))
		{
			...
			return view('admin.all_user.user_roles', compact('roles'));
		}
