...
class PayslipController extends Controller {
	...
	public function index(Request $request)
	{
		...
		if ($logged_user->can('view-payslip'))
		{
			...
			return view('admin.salary.payslip.index',compact('companies'));
		}
	...
	public function show(Payslip $payslip)
	{
		...
		return view('admin.salary.payslip.show',compact('payslip','employee','total_hours','amount_hours','leaveTypeUnserialize'));
	}
