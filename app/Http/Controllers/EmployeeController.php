...
class EmployeeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($logged_user->can('view-details-employee')) {
            ...
            return view('admin.employee.index', compact('companies', 'roles'));
        } else {
    ...
    public function show(Employee $employee)
    {
        if (auth()->user()->can('view-details-employee')) {
            ...
            return view('admin.employee.dashboard', compact('employee', 'countries', 'companies',
    ...
    {
        return view('admin.employee.social_profile.index', compact('employee'));
    }
    ...
    public function indexProfilePicture(Employee $employee)
    {
        ...
        if ($logged_user->can('modify-details-employee')) {
            return view('admin.employee.profile_picture.index', compact('employee'));
        }
    ...
    public function importPost()
    {
        ...
        try {
            ...
            return view('admin.employee.importError', compact('failures'));
        }
