...
class OfficeShiftController extends Controller {
	...
	public function index()
	{
		...
		if ($logged_user->can('view-office_shift'))
		{
			...
			return view('admin.timesheet.office_shift.index', compact('companies'));
		}
	...
	public function create()
	{
		...
		{
			return view('admin.timesheet.office_shift.create', compact('companies'));
		}
	...
	public function edit($id)
	{
		...
		if ($logged_user->can('edit-office_shift'))
		{
			...
			return view('admin.timesheet.office_shift.edit', compact('office_shift', 'company_name', 'companies'));
		}
		return response()->json(['success' => __('You are not authorized')]);
	}
