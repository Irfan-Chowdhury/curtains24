...
class ProjectController extends Controller {
	...
	public function index()
	{
		...
		if ($logged_user->can('view-project')){
			...
			return view('admin.projects.project.index', compact('companies', 'clients'));
		}
	...
	public function show(Project $project)
	{
		...
		if ($logged_user->can('view-project') || in_array($logged_user->id, $name))
		{
			...
			return view('admin.projects.project.details', compact('project', 'employees', 'company_name', 'name'));
		}
