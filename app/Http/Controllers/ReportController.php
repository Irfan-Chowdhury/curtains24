...
class ReportController extends Controller {
	...
	public function payslip(Request $request)
	{
		...
		if ($logged_user->can('report-payslip'))
		{
			...
			return view('admin.report.payslip_report', compact('companies'));
		}
	...
	public function attendance(Request $request)
	{
		...
		if ($logged_user->can('report-attendance'))
		{
			...
			return view('admin.report.attendance_report', compact('companies'));
		}
	...
	public function training(Request $request)
	{
		...
		if ($logged_user->can('report-training'))
		{
			...
			return view('admin.report.training_report', compact('companies'));
		}
	...
	public function project(Request $request)
	{
		...
		if ($logged_user->can('report-project'))
		{
			...
			return view('admin.report.project_report', compact('projects'));
		}
	...
	public function task(Request $request)
	{
		...
		if ($logged_user->can('report-task'))
		{
			...
			return view('admin.report.task_report', compact('tasks'));
		}
	...
	public function employees(Request $request)
	{
		...
		if ($logged_user->can('report-employee'))
		{
			...
			return view('admin.report.employees_report', compact('companies'));
		}
	...
	public function account(Request $request)
	{
		...
		if ($logged_user->can('report-account'))
		{
			...
			return view('admin.report.account_report', compact('accounts'));
		}
	...
	public function expense(Request $request)
	{
		...
		if ($logged_user->can('report-expense'))
		{
			...
			return view('admin.report.expense_report', compact('categories'));
		}
    ...
    public function pension(Request $request)
    {
        ...
        return view('admin.report.pension_report',compact('companies'));
    }
}
