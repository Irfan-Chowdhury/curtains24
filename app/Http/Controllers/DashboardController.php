...
class DashboardController extends Controller {
	...
	public function index()
	{
		...
		return view('admin.dashboard.admin_dashboard', compact('employees', 'attendance_count', 'leave_count', 'total_expense_raw', 'total_deposit_raw', 'total_expense', 'total_deposit', 'total_salaries_paid',
	...
	public function profile()
	{
		...
		if (!$employee)
		{
			...
			{
				return view('admin.profile.client_profile', compact('user'));
			}
		...
		} else
		{
			...
			return view('admin.profile.employee_profile', compact('user', 'employee', 'statuses',
	...
	public function employeeDashboard(Request $request)
	{
		...
		return view('admin.dashboard.employee_dashboard', compact('user', 'employee', 'employee_attendance',
	...
	public function clientDashboard()
	{
		...
		return view('admin.dashboard.client_dashboard', compact('user', 'client',
