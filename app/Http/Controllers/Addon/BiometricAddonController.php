...
class BiometricAddonController extends Controller
{
    ...
    {
        return view('admin.addons.biometric.step_1');
    }

    public function biometricInstallStep2()
    {
        return view('admin.addons.biometric.step_2');
    }

    public function biometricInstallStep3()
    {
        return view('admin.addons.biometric.step_3');
    }
    ...
    {
        return view('admin.addons.biometric.step_4');
    }
