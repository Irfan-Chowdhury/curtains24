...
class LanguageSettingController extends Controller
{
    ...
    public function index(Request $request, $language)
    {
        ...
        return view('admin.translation::languages.translations.index', compact('language', 'languages', 'groups', 'translations'));
    }
    ...
    {
        return view('admin.translation::languages.create');
    }
