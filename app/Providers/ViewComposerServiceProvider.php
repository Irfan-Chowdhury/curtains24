...
class ViewComposerServiceProvider extends ServiceProvider
{
    ...
    protected function loadGeneralSettingAndCheckCRM(bool $isCrmModuleExist) : void
    {
        ...
        view()->composer([
            'layout.main',
            'admin.layout.main',
            'admin.layout.main_partials.header',
            'admin.layout.main_partials.sidebar',
            'admin.layout.main_partials.footer',
            'admin.projects.invoices.show',
            'admin.dashboard',
            'admin.layout.client',
            'admin.frontend.Layout.navigation',
            'admin.documentation.index',
            'admin.vendor.translation.layout',
            'admin.all_user.index',
            'admin.addons.index',
            'admin.vendor.translation.languages.create'
